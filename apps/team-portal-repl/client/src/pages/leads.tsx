...
export default function Leads() {
  const { leads, activities, currentUser, updateLead, users } = useStore();
                      ...
                      <TableCell className="text-right pr-4">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-48">
                            <LogActivityDialog leadId={lead.id} trigger={<DropdownMenuItem onSelect={(e) => e.preventDefault()}>Log Activity</DropdownMenuItem>} />
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem className="text-[#DF1C41] hover:text-[#DF1C41] hover:bg-[#FFF0F3]">Mark as Lost</DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
                      </TableCell>
                    </TableRow>
